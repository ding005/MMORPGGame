...
namespace XLua.CSObjectWrap
{
    ...
    public class LitJsonJsonDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Inst_Object", _g_get_Inst_Object);
		    ...
		    try {
                ...
                
                {
                    LitJson.JsonData _x = (LitJson.JsonData)translator.GetObject(L, 2, typeof(LitJson.JsonData));
                        ...
                        bool gen_ret = gen_to_be_invoked.Equals( _x );
        ...
        static int _m_GetJsonType(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        LitJson.JsonType gen_ret = gen_to_be_invoked.GetJsonType(  );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Inst_Object(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                LitJson.JsonData gen_to_be_invoked = (LitJson.JsonData)translator.FastGetCSObj(L, 1);
                translator.PushAny(L, gen_to_be_invoked.Inst_Object);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
