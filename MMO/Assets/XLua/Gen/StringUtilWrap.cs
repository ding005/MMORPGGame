...
namespace XLua.CSObjectWrap
{
    ...
    public class StringUtilWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "ToInt", _m_ToInt_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "ToLong", _m_ToLong_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ToInt_xlua_st_(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ToLong_xlua_st_(RealStatePtr L)
        {
		    try {
