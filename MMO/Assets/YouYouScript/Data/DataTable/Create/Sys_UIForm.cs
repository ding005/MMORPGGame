...
public struct Sys_UIForm : IFlatbufferObject
{
  ...
  public sbyte UIGroupId { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetSbyte(o + __p.bb_pos) : (sbyte)0; } }
  ...
  public sbyte ShowMode { get { int o = __p.__offset(22); return o != 0 ? __p.bb.GetSbyte(o + __p.bb_pos) : (sbyte)0; } }
  public sbyte FreezeMode { get { int o = __p.__offset(24); return o != 0 ? __p.bb.GetSbyte(o + __p.bb_pos) : (sbyte)0; } }
  ...
  public static void AddUIGroupId(FlatBufferBuilder builder, sbyte UIGroupId) { builder.AddSbyte(3, UIGroupId, 0); }
  ...
  public static void AddShowMode(FlatBufferBuilder builder, sbyte ShowMode) { builder.AddSbyte(9, ShowMode, 0); }
  public static void AddFreezeMode(FlatBufferBuilder builder, sbyte FreezeMode) { builder.AddSbyte(10, FreezeMode, 0); }
