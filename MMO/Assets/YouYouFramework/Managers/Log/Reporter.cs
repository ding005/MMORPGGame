...
public class Reporter : MonoBehaviour
{
    ...
    private void LoadImage(BaseAction onComplete)
    {
...
"bar"
        ...
        for (int i = 0; i < images.Length; i++)
        {
            ...
            GameEntry.Resource.ResourceLoaderManager.LoadMainAsset(AssetCategory.Reporter, string.Format("Assets/Download/Reporter/ReporterRes/{0}.png", name), onComplete: (ResourceEntity entity) =>
             {
                 m_TextureDic[name] = entity.Target as Texture2D;
                 count++;
    ...
    public void Initialize()
    {
        ...
        LoadImage(() =>
        {
            ...
            GameEntry.Resource.ResourceLoaderManager.LoadMainAsset(AssetCategory.Reporter, "Assets/Download/Reporter/ReporterRes/reporterScrollerSkin.guiskin", onComplete: (ResourceEntity entity) =>
            {
                GUISkin skin = entity.Target as GUISkin;
