...
namespace YouYou
{
    ...
    public class LoggerManager : ManagerBase, IDisposable
    {
        ...
        public override void Init()
        {
            ...
            {
                m_LogPath = Application.persistentDataPath + "//" + DateTime.Now.ToString("yyyy-MM-dd-hh-mm-ss") + "-Start.txt";
            }
        }
        ...
        public void Write(string writeFileData, LogType type)
        {
            ...
            {
                m_LogPath = Application.persistentDataPath + "//" + DateTime.Now.ToString("yyyy-MM-dd-hh-mm-ss") + ".txt";
                m_LogMaxCapacity = 0;
            }
            m_CurrLogCount++;
